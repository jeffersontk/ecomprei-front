...
export default function Rastreio() {
  ...
  const codeDefaultValue =
    queryCode !== undefined && queryCode !== null ? String(queryCode) : ''
            ...
            {isLoading ? (
              <Stack w="100%" spacing={1}>
                ...
                <Link href="https://linketrack.com" target="_blank">
                  ...
                  >
                    <Text>API BY </Text>
                    <Text fontWeight="bold" color="#009688">
                      {' '}
                      LINK{' '}
                    </Text>
                    <Text fontWeight="bold" color="#ffa500">
                      {' '}
                      &{' '}
                    </Text>
                    <Text fontWeight="bold" color="#009688">
                  ...
                  <AccordionPanel pb={4}>
                    <Stack gap="2">
                      <Heading size="sm" color="gray.600">
                        As {track.hora} de {track.data} Em {track.local}
                      </Heading>
